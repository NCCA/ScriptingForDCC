...
def main() :
  ...
  for _,point in enumerate(points) :
    positions.append(Gf.Vec3f(w2-point[0],random.uniform(-0.1,0.1),h2-point[1]))
  ...
  invisibleIds = UsdGeom.PointInstancer.Get(stage,
                    "/World/TreePointInstance").GetInvisibleIdsAttr()
